...
void Container::Step() {
	this->physics.Diffuse(1, this->px, this->x, this->visc, this->dt, 16, this->size, this->temp);	
	this->physics.Diffuse(2, this->py, this->y, this->visc, this->dt, 16, this->size, this->temp);	

	this->physics.Project(this->px, this->py, this->x, this->y, 16, this->size, this->temp);
